...
#define NNCAM_APIV(x)   __declspec(dllexport)   x   __cdecl
#elif !defined(NNCAM_NOIMPORTS)
#define NNCAM_API(x)    __declspec(dllimport)   x   __stdcall
#define NNCAM_APIV(x)   __declspec(dllimport)   x   __cdecl
#else
#define NNCAM_API(x)    x   __stdcall
#define NNCAM_APIV(x)   x   __cdecl
#endif
#else   /* Linux or macOS */
#define NNCAM_API(x)    x
#define NNCAM_APIV(x)   x
...
#define NNCAM_FLAG_RAW10PACK            0x0200000000000000  /* pixel format, RAW 10bits packed */
#define NNCAM_FLAG_USB32                0x0400000000000000  /* usb3.2 */
#define NNCAM_FLAG_USB32_OVER_USB30     0x0800000000000000  /* usb3.2 camera connected to usb3.0 port */
...
#define NNCAM_BRIGHTNESS_MIN            (-255)  /* brightness */
#define NNCAM_BRIGHTNESS_MAX            255     /* brightness */
#define NNCAM_CONTRAST_DEF              0       /* contrast */
#define NNCAM_CONTRAST_MIN              (-255)  /* contrast */
#define NNCAM_CONTRAST_MAX              255     /* contrast */
...
#define NNCAM_AUTOEXPO_THLD_TRIGGER_DEF 5       /* auto exposure trigger threshold */
#define NNCAM_AUTOEXPO_THLD_TRIGGER_MIN 2       /* auto exposure trigger threshold */
#define NNCAM_AUTOEXPO_THLD_TRIGGER_MAX 64      /* auto exposure trigger threshold */
...
#define NNCAM_AE_PERCENT_DEF            1       /* auto exposure percent: enabled, percentage = 1% */
...
#endif
NNCAM_API(HRESULT)  Nncam_FfcFile(const void* data[], unsigned num, unsigned width, unsigned height, unsigned fourcc, unsigned bits, const char* outfile);
...
#define NNCAM_OPTION_THREAD_PRIORITY        0x02       /* [RW] set the priority of the internal thread which grab data from the usb device.
                                                         ...
                                                         */
#define NNCAM_OPTION_PROCESSMODE            0x03       /* [RW] obsolete & useless, noop. 0 = better image quality, more cpu usage. this is the default value; 1 = lower image quality, less cpu usage */
#define NNCAM_OPTION_RAW                    0x04       /* [RW]
                                                            0: RGB mode
...
#define NNCAM_OPTION_TRIGGER                0x0b       /* [RW] 0 = video mode, 1 = software or simulated trigger mode, 2 = external trigger mode, 3 = external + software trigger, 4 = self trigger, default value = 0 */
#define NNCAM_OPTION_RGB                    0x0c       /* [RW] 0 => RGB24; 1 => enable RGB48 format when bitdepth > 8; 2 => RGB32; 3 => 8 Bits Grey (only for mono camera); 4 => 16 Bits Grey (only for mono camera when bitdepth > 8); 5 => 64(RGB64) */
#define NNCAM_OPTION_COLORMATIX             0x0d       /* [RW] enable or disable the builtin color matrix, default value: 1 */
#define NNCAM_OPTION_WBGAIN                 0x0e       /* [RW] enable or disable the builtin white balance gain, default value: 1 */
#define NNCAM_OPTION_TECTARGET              0x0f       /* [RW] get or set the target temperature of the thermoelectric cooler, in 0.1 degree Celsius. For example, 125 means 12.5 degree Celsius, -35 means -3.5 degree Celsius. Set "-2730" or below means using the default for that model */
#define NNCAM_OPTION_AUTOEXP_POLICY         0x10       /* [RW] auto exposure policy:
                                                             0: Exposure Only
                                                             ...
                                                             default value: 1
                                                         */
#define NNCAM_OPTION_FRAMERATE              0x11       /* [RW] limit the frame rate, the default value 0 means no limit */
#define NNCAM_OPTION_DEMOSAIC               0x12       /* [RW] demosaic method for both video and still image: BILINEAR = 0, VNG(Variable Number of Gradients) = 1, PPG(Patterned Pixel Grouping) = 2, AHD(Adaptive Homogeneity Directed) = 3, EA(Edge Aware) = 4, see https://en.wikipedia.org/wiki/Demosaicing
...
#define NNCAM_OPTION_BINNING                0x17       /* [RW] digital binning
                                                         ...
                                                         */
#define NNCAM_OPTION_ROTATE                 0x18       /* [RW] rotate clockwise: 0, 90, 180, 270 */
#define NNCAM_OPTION_CG                     0x19       /* [RW] Conversion Gain:
                                                                0 = LCG
                                                                1 = HCG
                                                                2 = HDR (for camera with flag NNCAM_FLAG_CGHDR)
                                                                2 = MCG (for camera with flag NNCAM_FLAG_GHOPTO)
                                                         */
#define NNCAM_OPTION_PIXEL_FORMAT           0x1a       /* [RW] pixel format, NNCAM_PIXELFORMAT_xxxx */
#define NNCAM_OPTION_FFC                    0x1b       /* [RW] flat field correction
                                                             set:
                                                                  0: disable
                                                                  1: enable
                                                                 -1: reset
                                                         ...
                                                         */
#define NNCAM_OPTION_DDR_DEPTH              0x1c       /* [RW] the number of the frames that DDR can cache
...
#define NNCAM_OPTION_DFC                    0x1d       /* [RW] dark field correction
                                                             ...
                                                             get:
                                                                 ...
                                                                 ((val & 0xff0000) >> 16): average number
                                                         */
#define NNCAM_OPTION_SHARPENING             0x1e       /* [RW] Sharpening: (threshold << 24) | (radius << 16) | strength)
                                                             strength: [0, 500], default: 0 (disable)
                                                             radius: [1, 10]
                                                             threshold: [0, 255]
                                                         */
#define NNCAM_OPTION_FACTORY                0x1f       /* [WO] restore the factory settings */
#define NNCAM_OPTION_TEC_VOLTAGE            0x20       /* [RO] get the current TEC voltage in 0.1V, 59 mean 5.9V; readonly */
#define NNCAM_OPTION_TEC_VOLTAGE_MAX        0x21       /* [RW] TEC maximum voltage in 0.1V */
#define NNCAM_OPTION_DEVICE_RESET           0x22       /* [WO] reset usb device, simulate a replug */
#define NNCAM_OPTION_UPSIDE_DOWN            0x23       /* [RW] upsize down:
                                                             1: yes
                                                             0: no
                                                             default: 1 (win), 0 (linux/macos)
                                                         */
#define NNCAM_OPTION_FOCUSPOS               0x24       /* [RW] focus positon */
#define NNCAM_OPTION_AFMODE                 0x25       /* [RW] auto focus mode, see NncamAFMode */
#define NNCAM_OPTION_AFSTATUS               0x27       /* [RO] auto focus status, see NncamAFStaus */
#define NNCAM_OPTION_TESTPATTERN            0x28       /* [RW] test pattern:
                                                            0: off
                                                         ...
                                                         */
#define NNCAM_OPTION_AUTOEXP_THRESHOLD      0x29       /* [RW] threshold of auto exposure, default value: 5, range = [2, 15] */
#define NNCAM_OPTION_BYTEORDER              0x2a       /* [RW] Byte order, BGR or RGB: 0 => RGB, 1 => BGR, default value: 1(Win), 0(macOS, Linux, Android) */
#define NNCAM_OPTION_NOPACKET_TIMEOUT       0x2b       /* [RW] no packet timeout: 0 => disable, positive value (>= NNCAM_NOPACKET_TIMEOUT_MIN) => timeout milliseconds. default: disable */
#define NNCAM_OPTION_MAX_PRECISE_FRAMERATE  0x2c       /* [RO] get the precise frame rate maximum value in 0.1 fps, such as 115 means 11.5 fps */
...
#define NNCAM_OPTION_FRONTEND_DEQUE_LENGTH  0x31       /* [RW] frontend (raw) frame buffer deque length, range: [2, 1024], default: 4
                                                         ...
                                                         */
#define NNCAM_OPTION_FRAME_DEQUE_LENGTH     0x31       /* [RW] alias of NNCAM_OPTION_FRONTEND_DEQUE_LENGTH */
#define NNCAM_OPTION_MIN_PRECISE_FRAMERATE  0x32       /* [RO] get the precise frame rate minimum value in 0.1 fps, such as 15 means 1.5 fps */
#define NNCAM_OPTION_SEQUENCER_ONOFF        0x33       /* [RW] sequencer trigger: on/off */
#define NNCAM_OPTION_SEQUENCER_NUMBER       0x34       /* [RW] sequencer trigger: number, range = [1, 255] */
#define NNCAM_OPTION_SEQUENCER_EXPOTIME     0x01000000 /* [RW] sequencer trigger: exposure time, iOption = NNCAM_OPTION_SEQUENCER_EXPOTIME | index, iValue = exposure time
                                                         ...
                                                         */
#define NNCAM_OPTION_SEQUENCER_EXPOGAIN     0x02000000 /* [RW] sequencer trigger: exposure gain, iOption = NNCAM_OPTION_SEQUENCER_EXPOGAIN | index, iValue = gain */
#define NNCAM_OPTION_DENOISE                0x35       /* [RW] denoise, strength range: [0, 100], 0 means disable */
#define NNCAM_OPTION_HEAT_MAX               0x36       /* [RO] get maximum level: heat to prevent fogging up */
#define NNCAM_OPTION_HEAT                   0x37       /* [RW] heat to prevent fogging up */
#define NNCAM_OPTION_LOW_NOISE              0x38       /* [RW] low noise mode (Higher signal noise ratio, lower frame rate): 1 => enable */
#define NNCAM_OPTION_POWER                  0x39       /* [RO] get power consumption, unit: milliwatt */
#define NNCAM_OPTION_GLOBAL_RESET_MODE      0x3a       /* [RW] global reset mode */
#define NNCAM_OPTION_OPEN_ERRORCODE         0x3b       /* [RO] get the open camera error code */
#define NNCAM_OPTION_FLUSH                  0x3d       /* [WO]
                                                         ...
                                                         */
#define NNCAM_OPTION_NUMBER_DROP_FRAME      0x3e       /* [RO] get the number of frames that have been grabbed from the USB but dropped by the software */
#define NNCAM_OPTION_DUMP_CFG               0x3f       /* [RW] 0 = when camera is stopped, do not dump configuration automatically
                                                            1 = when camera is stopped, dump configuration automatically
                                                            -1 = explicitly dump configuration once
                                                            default: 1
                                                         */
#define NNCAM_OPTION_DEFECT_PIXEL           0x40       /* [RW] Defect Pixel Correction: 0 => disable, 1 => enable; default: 1 */
...
#define NNCAM_OPTION_BACKEND_DEQUE_CURRENT  0x46       /* [RO] get the current number in backend deque */
#define NNCAM_OPTION_EVENT_HARDWARE         0x04000000 /* [RW] enable or disable hardware event: 0 => disable, 1 => enable; default: disable
                                                         ...
                                                         */
#define NNCAM_OPTION_PACKET_NUMBER          0x47       /* [RO] get the received packet number */
#define NNCAM_OPTION_FILTERWHEEL_SLOT       0x48       /* [RW] filter wheel slot number */
#define NNCAM_OPTION_FILTERWHEEL_POSITION   0x49       /* [RW] filter wheel position:
                                                                set:
                                                                    -1: reset
                                                         ...
                                                         */
#define NNCAM_OPTION_AUTOEXPOSURE_PERCENT   0x4a       /* [RW] auto exposure percent to average:
                                                                1~99: peak percent average
                                                                0 or 100: full roi average, means "disabled"
                                                         */
#define NNCAM_OPTION_ANTI_SHUTTER_EFFECT    0x4b       /* [RW] anti shutter effect: 1 => enable, 0 => disable; default: 0 */
#define NNCAM_OPTION_CHAMBER_HT             0x4c       /* [RO] get chamber humidity & temperature:
                                                         ...
                                                         */
#define NNCAM_OPTION_ENV_HT                 0x4d       /* [RO] get environment humidity & temperature */
#define NNCAM_OPTION_EXPOSURE_PRE_DELAY     0x4e       /* [RW] exposure signal pre-delay, microsecond */
#define NNCAM_OPTION_EXPOSURE_POST_DELAY    0x4f       /* [RW] exposure signal post-delay, microsecond */
#define NNCAM_OPTION_AUTOEXPO_CONV          0x50       /* [RO] get auto exposure convergence status: 1(YES) or 0(NO), -1(PENDING) */
#define NNCAM_OPTION_AUTOEXPO_TRIGGER       0x51       /* [RW] auto exposure on trigger mode: 0 => disable, 1 => enable; default: 0 */
#define NNCAM_OPTION_LINE_PRE_DELAY         0x52       /* [RW] specified line signal pre-delay, microsecond */
#define NNCAM_OPTION_LINE_POST_DELAY        0x53       /* [RW] specified line signal post-delay, microsecond */
#define NNCAM_OPTION_TEC_VOLTAGE_MAX_RANGE  0x54       /* [RO] get the tec maximum voltage range:
                                                                high 16 bits: max
                                                                low 16 bits: min
                                                         */
#define NNCAM_OPTION_HIGH_FULLWELL          0x55       /* [RW] high fullwell capacity: 0 => disable, 1 => enable */
#define NNCAM_OPTION_DYNAMIC_DEFECT         0x56       /* [RW] dynamic defect pixel correction:
                                                                dead pixel ratio, t1: (high 16 bits): [0, 100], means: [0.0, 1.0]
                                                                hot pixel ratio, t2: (low 16 bits): [0, 100], means: [0.0, 1.0]
                                                         */
#define NNCAM_OPTION_HDR_KB                 0x57       /* [RW] HDR synthesize
                                                                K (high 16 bits): [1, 25500]
                                                                B (low 16 bits): [0, 65535]
                                                                0xffffffff => set to default
                                                         */
#define NNCAM_OPTION_HDR_THRESHOLD          0x58       /* [RW] HDR synthesize
                                                                threshold: [1, 4094]
                                                                0xffffffff => set to default
                                                         */
#define NNCAM_OPTION_GIGETIMEOUT            0x5a       /* [RW] For GigE cameras, the application periodically sends heartbeat signals to the camera to keep the connection to the camera alive.
                                                            ...
                                                            When the application is stopped by the debugger, the application cannot send the heartbeat signals
                                                                ...
                                                                default: auto
                                                         */
#define NNCAM_OPTION_EEPROM_SIZE            0x5b       /* [RO] get EEPROM size */
#define NNCAM_OPTION_OVERCLOCK_MAX          0x5c       /* [RO] get overclock range: [0, max] */
#define NNCAM_OPTION_OVERCLOCK              0x5d       /* [RW] overclock, default: 0 */
#define NNCAM_OPTION_RESET_SENSOR           0x5e       /* [WO] reset sensor */
#define NNCAM_OPTION_ISP                    0x5f       /* [RW] Enable hardware ISP: 0 => auto (disable in RAW mode, otherwise enable), 1 => enable, -1 => disable; default: 0 */
#define NNCAM_OPTION_AUTOEXP_EXPOTIME_DAMP  0x60       /* [RW] Auto exposure damping coefficient: time (thousandths). The larger the damping coefficient, the smoother and slower the exposure time changes */
#define NNCAM_OPTION_AUTOEXP_GAIN_DAMP      0x61       /* [RW] Auto exposure damping coefficient: gain (thousandths). The larger the damping coefficient, the smoother and slower the gain changes */
#define NNCAM_OPTION_MOTOR_NUMBER           0x62       /* [RW] range: [1, 20] */
...
#define NNCAM_OPTION_OVEREXP_POLICY         0x68       /* [RW] Auto exposure over exposure policy: when overexposed,
                                                            ...
                                                            Default: 0
                                                         */
#define NNCAM_OPTION_READOUT_MODE           0x69       /* [RW] Readout mode: 0 = IWR (Integrate While Read), 1 = ITR (Integrate Then Read)
                                                         ...
                                                         */
#define NNCAM_OPTION_TAILLIGHT              0x6a       /* [RW] Turn on/off tail Led light: 0 => off, 1 => on; default: on */
#define NNCAM_OPTION_LENSSTATE              0x6b       /* [RW] Load/Save lens state to EEPROM: 0 => load, 1 => save */
#define NNCAM_OPTION_AWB_CONTINUOUS         0x6c       /* [RW] Auto White Balance: continuous mode
                                                                0:  disable (default)
...
#define NNCAM_OPTION_RESET_SEQ_TIMESTAMP    0x74       /* [WO] Reset to 0: 1 => seq; 2 => timestamp; 3 => both */
#define NNCAM_OPTION_TRIGGER_CANCEL_MODE    0x75       /* [RW] Trigger cancel mode: 0 => no frame, 1 => output frame; default: 0 */
#define NNCAM_OPTION_MECHANICALSHUTTER      0x76       /* [RW] Mechanical shutter: 0 => open, 1 => close; default: 0 */
#define NNCAM_OPTION_LINE_TIME              0x77       /* [RO] Line-time of sensor in nanosecond */
#define NNCAM_OPTION_ZERO_PADDING           0x78       /* [RW] Zero padding: 0 => high, 1 => low; default: 0 */
...
#define NNCAM_OPTION_ALL_EXPO_TIME          0x82       /* [RO] */
#define NNCAM_OPTION_CAMERA_PERIOD          0x83       /* [RO] */
#define NNCAM_OPTION_FRONTEND_FULL          0x84       /* [RO] get the number of frontend deque full */
#define NNCAM_OPTION_BACKEND_FULL           0x85       /* [RO] get the number of backend deque full */
#define NNCAM_OPTION_GPS                    0x86       /* [RO] gps status: 0 => not supported; -1 => gps device offline; 1 => gps device online */
#define NNCAM_OPTION_LINE_LENGTH            0x87       /* [RW] Line length in pixel clock */
#define NNCAM_OPTION_SCAN_DIRECTION         0x88       /* [RW] Scan direction: 0(forward), 1(reverse), 2(alternate) */
#define NNCAM_OPTION_BLACKLEVEL_AUTOADJUST  0x89       /* [RW] Black level automatic adjustment function: 0: off, 1: on
...
#define NNCAM_IOCONTROLTYPE_GET_EFFECTIVE_TRIGGER_NUMBER 0x47 /* Effective trigger signal number */
...
NNCAM_API(HRESULT)  Nncam_PciEnable(PNNCAM_HOTPLUG funHotPlug, void* ctxHotPlug);
...
*/
#if defined(_WIN32)
NNCAM_API(HRESULT)  Nncam_CtiEnable(PNNCAM_HOTPLUG funHotPlug, void* ctxHotPlug, const wchar_t* ctiPath[]);
#else
...
NNCAM_API(void)     Nncam_log_str(unsigned level, const char* str);
NNCAM_APIV(void)    Nncam_log(unsigned level, const char* format, ...);

#if defined(NNCAM_LOG)
#define NNCAM_LOG_NONE(format, ...)     Nncam_log(0, format, ##__VA_ARGS__)
#define NNCAM_LOG_ERROR(format, ...)    Nncam_log(1, format, ##__VA_ARGS__)
#define NNCAM_LOG_DEBUG(format, ...)    Nncam_log(2, format, ##__VA_ARGS__)
#define NNCAM_LOG_VERBOSE(format, ...)  Nncam_log(3, format, ##__VA_ARGS__)
/* for example: NNCAM_LOG_DEBUG("%s: blahblah, x = %d, y = %f", __func__ x, y); */
#endif
