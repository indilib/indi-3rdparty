...
"""
This script lists all drivers in the debian directory, 
extracts their versions from the changelog file, 
and gets the latest git hash for each driver.
"""
...
drivers_directory_path = root_directory / 'debian'
...
def get_driver_info(drivers_directory_path):
    ...
    if drivers_list:
        ...
        for driver in drivers_list:
            ...
            print(f"{driver}: Version {version}, Git Hash: {git_hash}")
