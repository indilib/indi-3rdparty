...
//Comment out if your setup don't include some sensor.Some sensor combinations are exclusive
...
//Set DAYLIGHT to the SQM output at start of dusk.
#define DAYLIGHT 10.0
