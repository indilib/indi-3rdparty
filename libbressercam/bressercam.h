...
#define BRESSERCAM_GVCP_RETRY_MAX            16
#define BRESSERCAM_GVCP_TIMEOUT_DEF          15      /* GVCP Timeout */
#define BRESSERCAM_GVCP_TIMEOUT_MIN          5
#define BRESSERCAM_GVCP_TIMEOUT_MAX          150
