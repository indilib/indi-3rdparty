...
#define STARSHOOTG_APIV(x)   __declspec(dllexport)   x   __cdecl
#elif !defined(STARSHOOTG_NOIMPORTS)
#define STARSHOOTG_API(x)    __declspec(dllimport)   x   __stdcall
#define STARSHOOTG_APIV(x)   __declspec(dllimport)   x   __cdecl
#else
#define STARSHOOTG_API(x)    x   __stdcall
#define STARSHOOTG_APIV(x)   x   __cdecl
#endif
#else   /* Linux or macOS */
#define STARSHOOTG_API(x)    x
#define STARSHOOTG_APIV(x)   x
...
#define STARSHOOTG_AUTOEXPO_THLD_TRIGGER_DEF 5       /* auto exposure trigger threshold */
#define STARSHOOTG_AUTOEXPO_THLD_TRIGGER_MIN 2       /* auto exposure trigger threshold */
#define STARSHOOTG_AUTOEXPO_THLD_TRIGGER_MAX 64      /* auto exposure trigger threshold */
...
#define STARSHOOTG_AE_PERCENT_DEF            1       /* auto exposure percent: enabled, percentage = 1% */
...
/*
    ...
    nNumber:    0xffff:     trigger continuously
                0:          cancel trigger, see STARSHOOTG_OPTION_TRIGGER_CANCEL_MODE
...
#endif
STARSHOOTG_API(HRESULT)  Starshootg_FfcFile(const void* data[], unsigned num, unsigned width, unsigned height, unsigned fourcc, unsigned bits, const char* outfile);
...
#define STARSHOOTG_OPTION_RAW                    0x04       /* [RW]
                                                            ...
                                                            default value: 0
                                                         */
#define STARSHOOTG_OPTION_HISTOGRAM              0x05       /* [RW] 0 = only one, 1 = continue mode */
#define STARSHOOTG_OPTION_BITDEPTH               0x06       /* [RW] 0 = 8 bits mode, 1 = 16 bits mode, subset of STARSHOOTG_OPTION_PIXEL_FORMAT */
#define STARSHOOTG_OPTION_FAN                    0x07       /* [RW] 0 = turn off the cooling fan, [1, max] = fan speed, , set to "-1" means to use default fan speed */
#define STARSHOOTG_OPTION_TEC                    0x08       /* [RW] 0 = turn off the thermoelectric cooler, 1 = turn on the thermoelectric cooler */
#define STARSHOOTG_OPTION_LINEAR                 0x09       /* [RW] 0 = turn off the builtin linear tone mapping, 1 = turn on the builtin linear tone mapping, default value: 1 */
#define STARSHOOTG_OPTION_CURVE                  0x0a       /* [RW] 0 = turn off the builtin curve tone mapping, 1 = turn on the builtin polynomial curve tone mapping, 2 = logarithmic curve tone mapping, default value: 2 */
#define STARSHOOTG_OPTION_TRIGGER                0x0b       /* [RW] 0 = video mode, 1 = software or simulated trigger mode, 2 = external trigger mode, 3 = external + software trigger, 4 = self trigger, default value = 0 */
#define STARSHOOTG_OPTION_RGB                    0x0c       /* [RW] 0 => RGB24; 1 => enable RGB48 format when bitdepth > 8; 2 => RGB32; 3 => 8 Bits Grey (only for mono camera); 4 => 16 Bits Grey (only for mono camera when bitdepth > 8); 5 => 64(RGB64) */
#define STARSHOOTG_OPTION_COLORMATIX             0x0d       /* [RW] enable or disable the builtin color matrix, default value: 1 */
#define STARSHOOTG_OPTION_WBGAIN                 0x0e       /* [RW] enable or disable the builtin white balance gain, default value: 1 */
#define STARSHOOTG_OPTION_TECTARGET              0x0f       /* [RW] get or set the target temperature of the thermoelectric cooler, in 0.1 degree Celsius. For example, 125 means 12.5 degree Celsius, -35 means -3.5 degree Celsius. Set "-2730" or below means using the default for that model */
#define STARSHOOTG_OPTION_AUTOEXP_POLICY         0x10       /* [RW] auto exposure policy:
                                                             0: Exposure Only
                                                             ...
                                                             default value: 1
                                                         */
#define STARSHOOTG_OPTION_FRAMERATE              0x11       /* [RW] limit the frame rate, the default value 0 means no limit */
#define STARSHOOTG_OPTION_DEMOSAIC               0x12       /* [RW] demosaic method for both video and still image: BILINEAR = 0, VNG(Variable Number of Gradients) = 1, PPG(Patterned Pixel Grouping) = 2, AHD(Adaptive Homogeneity Directed) = 3, EA(Edge Aware) = 4, see https://en.wikipedia.org/wiki/Demosaicing
...
#define STARSHOOTG_OPTION_BINNING                0x17       /* [RW] digital binning
                                                         ...
                                                         */
#define STARSHOOTG_OPTION_ROTATE                 0x18       /* [RW] rotate clockwise: 0, 90, 180, 270 */
#define STARSHOOTG_OPTION_CG                     0x19       /* [RW] Conversion Gain:
                                                                0 = LCG
                                                                1 = HCG
                                                                2 = HDR (for camera with flag STARSHOOTG_FLAG_CGHDR)
                                                                2 = MCG (for camera with flag STARSHOOTG_FLAG_GHOPTO)
                                                         */
#define STARSHOOTG_OPTION_PIXEL_FORMAT           0x1a       /* [RW] pixel format, STARSHOOTG_PIXELFORMAT_xxxx */
#define STARSHOOTG_OPTION_FFC                    0x1b       /* [RW] flat field correction
                                                             set:
                                                                  0: disable
                                                                  1: enable
                                                                 -1: reset
                                                         ...
                                                         */
#define STARSHOOTG_OPTION_DDR_DEPTH              0x1c       /* [RW] the number of the frames that DDR can cache
...
#define STARSHOOTG_OPTION_DFC                    0x1d       /* [RW] dark field correction
                                                             ...
                                                             get:
                                                                 ...
                                                                 ((val & 0xff0000) >> 16): average number
                                                         */
#define STARSHOOTG_OPTION_SHARPENING             0x1e       /* [RW] Sharpening: (threshold << 24) | (radius << 16) | strength)
                                                             strength: [0, 500], default: 0 (disable)
                                                             radius: [1, 10]
                                                             threshold: [0, 255]
                                                         */
#define STARSHOOTG_OPTION_FACTORY                0x1f       /* [WO] restore the factory settings */
#define STARSHOOTG_OPTION_TEC_VOLTAGE            0x20       /* [RO] get the current TEC voltage in 0.1V, 59 mean 5.9V; readonly */
#define STARSHOOTG_OPTION_TEC_VOLTAGE_MAX        0x21       /* [RW] TEC maximum voltage in 0.1V */
#define STARSHOOTG_OPTION_DEVICE_RESET           0x22       /* [WO] reset usb device, simulate a replug */
#define STARSHOOTG_OPTION_UPSIDE_DOWN            0x23       /* [RW] upsize down:
                                                             1: yes
                                                             0: no
                                                             default: 1 (win), 0 (linux/macos)
                                                         */
#define STARSHOOTG_OPTION_FOCUSPOS               0x24       /* [RW] focus positon */
#define STARSHOOTG_OPTION_AFMODE                 0x25       /* [RW] auto focus mode, see StarshootgAFMode */
#define STARSHOOTG_OPTION_AFSTATUS               0x27       /* [RO] auto focus status, see StarshootgAFStaus */
#define STARSHOOTG_OPTION_TESTPATTERN            0x28       /* [RW] test pattern:
                                                            0: off
                                                         ...
                                                         */
#define STARSHOOTG_OPTION_AUTOEXP_THRESHOLD      0x29       /* [RW] threshold of auto exposure, default value: 5, range = [2, 15] */
#define STARSHOOTG_OPTION_BYTEORDER              0x2a       /* [RW] Byte order, BGR or RGB: 0 => RGB, 1 => BGR, default value: 1(Win), 0(macOS, Linux, Android) */
#define STARSHOOTG_OPTION_NOPACKET_TIMEOUT       0x2b       /* [RW] no packet timeout: 0 => disable, positive value (>= STARSHOOTG_NOPACKET_TIMEOUT_MIN) => timeout milliseconds. default: disable */
#define STARSHOOTG_OPTION_MAX_PRECISE_FRAMERATE  0x2c       /* [RO] get the precise frame rate maximum value in 0.1 fps, such as 115 means 11.5 fps */
#define STARSHOOTG_OPTION_PRECISE_FRAMERATE      0x2d       /* [RW] precise frame rate current value in 0.1 fps. use STARSHOOTG_OPTION_MAX_PRECISE_FRAMERATE, STARSHOOTG_OPTION_MIN_PRECISE_FRAMERATE to get the range. if the set value is out of range, E_INVALIDARG will be returned */
#define STARSHOOTG_OPTION_BANDWIDTH              0x2e       /* [RW] bandwidth, [1-100]% */
#define STARSHOOTG_OPTION_RELOAD                 0x2f       /* [RW] reload the last frame in trigger mode */
#define STARSHOOTG_OPTION_CALLBACK_THREAD        0x30       /* [RW] dedicated thread for callback: 0 => disable, 1 => enable, default: 0 */
#define STARSHOOTG_OPTION_FRONTEND_DEQUE_LENGTH  0x31       /* [RW] frontend (raw) frame buffer deque length, range: [2, 1024], default: 4
                                                            All the memory will be pre-allocated when the camera starts, so, please attention to memory usage
                                                         */
#define STARSHOOTG_OPTION_FRAME_DEQUE_LENGTH     0x31       /* [RW] alias of STARSHOOTG_OPTION_FRONTEND_DEQUE_LENGTH */
#define STARSHOOTG_OPTION_MIN_PRECISE_FRAMERATE  0x32       /* [RO] get the precise frame rate minimum value in 0.1 fps, such as 15 means 1.5 fps */
#define STARSHOOTG_OPTION_SEQUENCER_ONOFF        0x33       /* [RW] sequencer trigger: on/off */
#define STARSHOOTG_OPTION_SEQUENCER_NUMBER       0x34       /* [RW] sequencer trigger: number, range = [1, 255] */
#define STARSHOOTG_OPTION_SEQUENCER_EXPOTIME     0x01000000 /* [RW] sequencer trigger: exposure time, iOption = STARSHOOTG_OPTION_SEQUENCER_EXPOTIME | index, iValue = exposure time
                                                         ...
                                                         */
#define STARSHOOTG_OPTION_SEQUENCER_EXPOGAIN     0x02000000 /* [RW] sequencer trigger: exposure gain, iOption = STARSHOOTG_OPTION_SEQUENCER_EXPOGAIN | index, iValue = gain */
#define STARSHOOTG_OPTION_DENOISE                0x35       /* [RW] denoise, strength range: [0, 100], 0 means disable */
#define STARSHOOTG_OPTION_HEAT_MAX               0x36       /* [RO] get maximum level: heat to prevent fogging up */
#define STARSHOOTG_OPTION_HEAT                   0x37       /* [RW] heat to prevent fogging up */
#define STARSHOOTG_OPTION_LOW_NOISE              0x38       /* [RW] low noise mode (Higher signal noise ratio, lower frame rate): 1 => enable */
#define STARSHOOTG_OPTION_POWER                  0x39       /* [RO] get power consumption, unit: milliwatt */
#define STARSHOOTG_OPTION_GLOBAL_RESET_MODE      0x3a       /* [RW] global reset mode */
#define STARSHOOTG_OPTION_OPEN_ERRORCODE         0x3b       /* [RO] get the open camera error code */
#define STARSHOOTG_OPTION_FLUSH                  0x3d       /* [WO]
                                                         ...
                                                         */
#define STARSHOOTG_OPTION_NUMBER_DROP_FRAME      0x3e       /* [RO] get the number of frames that have been grabbed from the USB but dropped by the software */
#define STARSHOOTG_OPTION_DUMP_CFG               0x3f       /* [RW] 0 = when camera is stopped, do not dump configuration automatically
                                                            1 = when camera is stopped, dump configuration automatically
                                                            -1 = explicitly dump configuration once
                                                            default: 1
                                                         */
#define STARSHOOTG_OPTION_DEFECT_PIXEL           0x40       /* [RW] Defect Pixel Correction: 0 => disable, 1 => enable; default: 1 */
#define STARSHOOTG_OPTION_BACKEND_DEQUE_LENGTH   0x41       /* [RW] backend (pipelined) frame buffer deque length (Only available in pull mode), range: [2, 1024], default: 3
                                                            All the memory will be pre-allocated when the camera starts, so, please attention to memory usage
                                                         */
#define STARSHOOTG_OPTION_LIGHTSOURCE_MAX        0x42       /* [RO] get the light source range, [0 ~ max] */
#define STARSHOOTG_OPTION_LIGHTSOURCE            0x43       /* [RW] light source */
#define STARSHOOTG_OPTION_HEARTBEAT              0x44       /* [RW] Heartbeat interval in millisecond, range = [STARSHOOTG_HEARTBEAT_MIN, STARSHOOTG_HEARTBEAT_MAX], 0 = disable, default: disable */
#define STARSHOOTG_OPTION_FRONTEND_DEQUE_CURRENT 0x45       /* [RO] get the current number in frontend deque */
#define STARSHOOTG_OPTION_BACKEND_DEQUE_CURRENT  0x46       /* [RO] get the current number in backend deque */
#define STARSHOOTG_OPTION_EVENT_HARDWARE         0x04000000 /* [RW] enable or disable hardware event: 0 => disable, 1 => enable; default: disable
                                                         ...
                                                         */
#define STARSHOOTG_OPTION_PACKET_NUMBER          0x47       /* [RO] get the received packet number */
#define STARSHOOTG_OPTION_FILTERWHEEL_SLOT       0x48       /* [RW] filter wheel slot number */
#define STARSHOOTG_OPTION_FILTERWHEEL_POSITION   0x49       /* [RW] filter wheel position:
                                                                set:
                                                                    -1: reset
                                                         ...
                                                         */
#define STARSHOOTG_OPTION_AUTOEXPOSURE_PERCENT   0x4a       /* [RW] auto exposure percent to average:
                                                                1~99: peak percent average
                                                                0 or 100: full roi average, means "disabled"
                                                         */
#define STARSHOOTG_OPTION_ANTI_SHUTTER_EFFECT    0x4b       /* [RW] anti shutter effect: 1 => enable, 0 => disable; default: 0 */
#define STARSHOOTG_OPTION_CHAMBER_HT             0x4c       /* [RO] get chamber humidity & temperature:
                                                         ...
                                                         */
#define STARSHOOTG_OPTION_ENV_HT                 0x4d       /* [RO] get environment humidity & temperature */
#define STARSHOOTG_OPTION_EXPOSURE_PRE_DELAY     0x4e       /* [RW] exposure signal pre-delay, microsecond */
#define STARSHOOTG_OPTION_EXPOSURE_POST_DELAY    0x4f       /* [RW] exposure signal post-delay, microsecond */
#define STARSHOOTG_OPTION_AUTOEXPO_CONV          0x50       /* [RO] get auto exposure convergence status: 1(YES) or 0(NO), -1(PENDING) */
#define STARSHOOTG_OPTION_AUTOEXPO_TRIGGER       0x51       /* [RW] auto exposure on trigger mode: 0 => disable, 1 => enable; default: 0 */
#define STARSHOOTG_OPTION_LINE_PRE_DELAY         0x52       /* [RW] specified line signal pre-delay, microsecond */
#define STARSHOOTG_OPTION_LINE_POST_DELAY        0x53       /* [RW] specified line signal post-delay, microsecond */
#define STARSHOOTG_OPTION_TEC_VOLTAGE_MAX_RANGE  0x54       /* [RO] get the tec maximum voltage range:
                                                                high 16 bits: max
                                                                low 16 bits: min
                                                         */
#define STARSHOOTG_OPTION_HIGH_FULLWELL          0x55       /* [RW] high fullwell capacity: 0 => disable, 1 => enable */
#define STARSHOOTG_OPTION_DYNAMIC_DEFECT         0x56       /* [RW] dynamic defect pixel correction:
                                                                dead pixel ratio, t1: (high 16 bits): [0, 100], means: [0.0, 1.0]
                                                                hot pixel ratio, t2: (low 16 bits): [0, 100], means: [0.0, 1.0]
                                                         */
#define STARSHOOTG_OPTION_HDR_KB                 0x57       /* [RW] HDR synthesize
                                                                K (high 16 bits): [1, 25500]
                                                                B (low 16 bits): [0, 65535]
                                                                0xffffffff => set to default
                                                         */
#define STARSHOOTG_OPTION_HDR_THRESHOLD          0x58       /* [RW] HDR synthesize
                                                                threshold: [1, 4094]
                                                                0xffffffff => set to default
                                                         */
#define STARSHOOTG_OPTION_GIGETIMEOUT            0x5a       /* [RW] For GigE cameras, the application periodically sends heartbeat signals to the camera to keep the connection to the camera alive.
                                                            ...
                                                            When the application is stopped by the debugger, the application cannot send the heartbeat signals
                                                                ...
                                                                default: auto
                                                         */
#define STARSHOOTG_OPTION_EEPROM_SIZE            0x5b       /* [RO] get EEPROM size */
#define STARSHOOTG_OPTION_OVERCLOCK_MAX          0x5c       /* [RO] get overclock range: [0, max] */
#define STARSHOOTG_OPTION_OVERCLOCK              0x5d       /* [RW] overclock, default: 0 */
#define STARSHOOTG_OPTION_RESET_SENSOR           0x5e       /* [WO] reset sensor */
#define STARSHOOTG_OPTION_ISP                    0x5f       /* [RW] Enable hardware ISP: 0 => auto (disable in RAW mode, otherwise enable), 1 => enable, -1 => disable; default: 0 */
#define STARSHOOTG_OPTION_AUTOEXP_EXPOTIME_DAMP  0x60       /* [RW] Auto exposure damping coefficient: time (thousandths). The larger the damping coefficient, the smoother and slower the exposure time changes */
#define STARSHOOTG_OPTION_AUTOEXP_GAIN_DAMP      0x61       /* [RW] Auto exposure damping coefficient: gain (thousandths). The larger the damping coefficient, the smoother and slower the gain changes */
#define STARSHOOTG_OPTION_MOTOR_NUMBER           0x62       /* [RW] range: [1, 20] */
#define STARSHOOTG_OPTION_MOTOR_POS              0x10000000 /* [RW] range: [1, 702] */
#define STARSHOOTG_OPTION_PSEUDO_COLOR_START     0x63       /* [RW] Pseudo: start color, BGR format */
#define STARSHOOTG_OPTION_PSEUDO_COLOR_END       0x64       /* [RW] Pseudo: end color, BGR format */
#define STARSHOOTG_OPTION_PSEUDO_COLOR_ENABLE    0x65       /* [RW] Pseudo: -1 => custom: use startcolor & endcolor to generate the colormap
                                                                    0 => disable
                                                                    1 => spot
                                                                    2 => spring
                                                                    3 => summer
...
#define STARSHOOTG_OPTION_FPNC                   0x67       /* [RW] Fix Pattern Noise Correction
                                                             ...
                                                             get:
                                                                 ...
                                                                 ((val & 0xff0000) >> 16): average number
                                                         */
#define STARSHOOTG_OPTION_OVEREXP_POLICY         0x68       /* [RW] Auto exposure over exposure policy: when overexposed,
                                                            ...
                                                            Default: 0
                                                         */
#define STARSHOOTG_OPTION_READOUT_MODE           0x69       /* [RW] Readout mode: 0 = IWR (Integrate While Read), 1 = ITR (Integrate Then Read)
                                                         ...
                                                         */
#define STARSHOOTG_OPTION_TAILLIGHT              0x6a       /* [RW] Turn on/off tail Led light: 0 => off, 1 => on; default: on */
#define STARSHOOTG_OPTION_LENSSTATE              0x6b       /* [RW] Load/Save lens state to EEPROM: 0 => load, 1 => save */
#define STARSHOOTG_OPTION_AWB_CONTINUOUS         0x6c       /* [RW] Auto White Balance: continuous mode
                                                                0:  disable (default)
                                                                n>0: every n millisecond(s)
                                                                n<0: every -n frame
                                                         */
#define STARSHOOTG_OPTION_TECTARGET_RANGE        0x6d       /* [RO] TEC target range: min(low 16 bits) = (short)(val & 0xffff), max(high 16 bits) = (short)((val >> 16) & 0xffff) */
#define STARSHOOTG_OPTION_CDS                    0x6e       /* [RW] Correlated Double Sampling: 0~100 */
#define STARSHOOTG_OPTION_LOW_POWER_EXPOTIME     0x6f       /* [RW] Low Power Consumption: Enable if exposure time is greater than the set value */
#define STARSHOOTG_OPTION_ZERO_OFFSET            0x70       /* [RW] Sensor output offset to zero: 0 => disable, 1 => eanble; default: 0 */
#define STARSHOOTG_OPTION_GVCP_TIMEOUT           0x71       /* [RW] GVCP Timeout: millisecond, range = [3, 75], default: 15
                                                              Unless in very special circumstances, generally no modification is required, just use the default value
                                                         */
#define STARSHOOTG_OPTION_GVCP_RETRY             0x72       /* [RW] GVCP Retry: range = [2, 8], default: 4
                                                              Unless in very special circumstances, generally no modification is required, just use the default value
                                                         */
#define STARSHOOTG_OPTION_GVSP_WAIT_PERCENT      0x73       /* [RW] GVSP wait percent: range = [0, 100], default = (trigger mode: 100, realtime: 0, other: 1) */
#define STARSHOOTG_OPTION_RESET_SEQ_TIMESTAMP    0x74       /* [WO] Reset to 0: 1 => seq; 2 => timestamp; 3 => both */
#define STARSHOOTG_OPTION_TRIGGER_CANCEL_MODE    0x75       /* [RW] Trigger cancel mode: 0 => no frame, 1 => output frame; default: 0 */
#define STARSHOOTG_OPTION_MECHANICALSHUTTER      0x76       /* [RW] Mechanical shutter: 0 => open, 1 => close; default: 0 */
#define STARSHOOTG_OPTION_LINE_TIME              0x77       /* [RO] Line-time of sensor in nanosecond */
#define STARSHOOTG_OPTION_ZERO_PADDING           0x78       /* [RW] Zero padding: 0 => high, 1 => low; default: 0 */
#define STARSHOOTG_OPTION_UPTIME                 0x79       /* [RO] device uptime in millisecond */
#define STARSHOOTG_OPTION_BITRANGE               0x7a       /* [RW] Bit range: [0, 8] */
#define STARSHOOTG_OPTION_MODE_SEQ_TIMESTAMP     0x7b       /* [RW] Mode of seq & timestamp: 0 => reset to 0 automatically; 1 => never reset automatically; default: 0 */
#define TOUPCAP_OPTION_TIMED_TRIGGER_NUM      0x7c       /* [RW] Timed trigger number */
#define STARSHOOTG_OPTION_TIMED_TRIGGER_LOW      0x20000000 /* [RW] Timed trigger: lower 32 bits of 64-bit integer, nanosecond since epoch (00:00:00 UTC on Thursday, 1 January 1970, see https://en.wikipedia.org/wiki/Unix_time) */
#define STARSHOOTG_OPTION_TIMED_TRIGGER_HIGH     0x40000000 /* [RW] Timed trigger: high 32 bits. The lower 32 bits must be set first, followed by the higher 32 bits */
#define STARSHOOTG_OPTION_AUTOEXP_THLD_TRIGGER   0x7d       /* [RW] trigger threshold of auto exposure */
#define STARSHOOTG_OPTION_LANE                   0x7e       /* [RW] */
#define STARSHOOTG_OPTION_VOLTAGEBIAS            0x7f       /* [RW] Voltage bias */
#define STARSHOOTG_OPTION_VOLTAGEBIAS_RANGE      0x80       /* [RO] Voltage bias range: min (low 16bits), max (high 16bits) */
#define STARSHOOTG_OPTION_READ_TIME              0x81       /* [RO] */
#define STARSHOOTG_OPTION_ALL_EXPO_TIME          0x82       /* [RO] */
#define STARSHOOTG_OPTION_CAMERA_PERIOD          0x83       /* [RO] */
#define STARSHOOTG_OPTION_FRONTEND_FULL          0x84       /* [RO] get the number of frontend deque full */
#define STARSHOOTG_OPTION_BACKEND_FULL           0x85       /* [RO] get the number of backend deque full */
#define STARSHOOTG_OPTION_GPS                    0x86       /* [RO] gps status: 0 => not supported; -1 => gps device offline; 1 => gps device online */
#define STARSHOOTG_OPTION_LINE_LENGTH            0x87       /* [RW] Line length in pixel clock */
#define STARSHOOTG_OPTION_SCAN_DIRECTION         0x88       /* [RW] Scan direction: 0(forward), 1(reverse), 2(alternate) */
#define STARSHOOTG_OPTION_BLACKLEVEL_AUTOADJUST  0x89       /* [RW] Black level automatic adjustment function: 0: off, 1: on
...
#define STARSHOOTG_IOCONTROLTYPE_GET_PWM_FREQ                 0x19 /* PWM Frequency */
#define STARSHOOTG_IOCONTROLTYPE_SET_PWM_FREQ                 0x1a
#define STARSHOOTG_IOCONTROLTYPE_GET_PWM_DUTYRATIO            0x1b /* PWM Duty Ratio */
#define STARSHOOTG_IOCONTROLTYPE_SET_PWM_DUTYRATIO            0x1c
#define STARSHOOTG_IOCONTROLTYPE_GET_PWMSOURCE                0x1d /* PWM Source: 0x00 => Opto-isolated input, 0x01 => GPIO0, 0x02 => GPIO1 */
...
*/
#if defined(_WIN32)
STARSHOOTG_API(HRESULT)  Starshootg_CtiEnable(PSTARSHOOTG_HOTPLUG funHotPlug, void* ctxHotPlug, const wchar_t* ctiPath[]);
#else
STARSHOOTG_API(HRESULT)  Starshootg_CtiEnable(PSTARSHOOTG_HOTPLUG funHotPlug, void* ctxHotPlug, const char* ctiPath[]);
#endif
...
STARSHOOTG_API(void)     Starshootg_log_str(unsigned level, const char* str);
STARSHOOTG_APIV(void)    Starshootg_log(unsigned level, const char* format, ...);

#if defined(STARSHOOTG_LOG)
#define STARSHOOTG_LOG_NONE(format, ...)     Starshootg_log(0, format, ##__VA_ARGS__)
#define STARSHOOTG_LOG_ERROR(format, ...)    Starshootg_log(1, format, ##__VA_ARGS__)
#define STARSHOOTG_LOG_DEBUG(format, ...)    Starshootg_log(2, format, ##__VA_ARGS__)
#define STARSHOOTG_LOG_VERBOSE(format, ...)  Starshootg_log(3, format, ##__VA_ARGS__)
/* for example: STARSHOOTG_LOG_DEBUG("%s: blahblah, x = %d, y = %f", __func__ x, y); */
#endif
