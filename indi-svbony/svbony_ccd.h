...
class SVBONYCCD : public SVBONYBase
{
    public:
        explicit SVBONYCCD(const SVB_CAMERA_INFO &camInfo, const std::string &cameraName,
    ...
    private:
        void loadNicknames();
        void saveNicknames();
        const std::string NICKNAME_FILE = "/.indi/SVBONYNicknames.xml";
