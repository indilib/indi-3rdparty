...
class QSI_Registry
{
    public:
        ...
        QSI_AdvSettings GetAdvancedSetupSettings( std::string strSerialNumber, bool bIsMainCamera, QSI_AdvSettings DefaultSettings )
        {
            ...
            AdvSettings.OptimizeReadoutSpeed = GetBoolean( KeyPath, SUBKEY_OptimizeReadoutSpeedCheck,
                                               DefaultSettings.OptimizeReadoutSpeed );
            ...
            AdvSettings.PreExposureFlushIndex = GetNumber( KeyPath, SUBKEY_PreExposureFlushIndex,
                                                DefaultSettings.PreExposureFlushIndex );
            // Filter Wheel settings
